...
def extractConUn(pdf_path, i):
    # try:
        print("<------------extracting Control Union pdf------------>")
        ...
        if table_extract:
            ...
            table_data4 = page_tables[5][1]
            # table_data4 = page_tables[3]
            global identification_numbers
            ...
            try:
                print("---------")
                if identification_numbers == None and "identification no." in table_data2[0].lower():
                    identification_numbers = table_data2[2].strip()
                    print(identification_numbers)
                if not description and "description" in table_data1[0].lower():
                    description = table_data4[0]
                    print("---------------")
                    print(description)
                if not swl and "working load limit" in table_data3[0].lower():
                    swl = table_data3[2].strip()
                    print("------------------")
                    print("swl:", swl)
...
#     extractEner("../resources/EnerMech.pdf", 1)
