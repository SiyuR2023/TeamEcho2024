...
def extractEner(pdf_path, i):
    # try:
        ...
        if table_extract:
            ...
            table_data1 = page_tables[0]
            table_data2 = page_tables[1][0]
            table_data3 = page_tables[2]
            table_data4 = page_tables[1][1]
            ...
            for index in range(0, len(table_data2)):
                try:
                    ...
                    # print("---------")
                    if identification_numbers == None and "unique" in text_to_compare:
